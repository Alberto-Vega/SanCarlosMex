...
public class Popover: UIView {
    ...
    public func show(contentView: UIView, fromView: UIView) {
        ...
        self.show(contentView: contentView, fromView: fromView, inView: keyWindow)
    }
    ...
    public func show(contentView: UIView, point: CGPoint) {
        ...
        self.show(contentView: contentView, point: point, inView: keyWindow)
    }
